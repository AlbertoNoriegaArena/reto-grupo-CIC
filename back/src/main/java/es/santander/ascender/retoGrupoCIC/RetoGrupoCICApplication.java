...
public class RetoGrupoCICApplication {
        ...
        //                 // Musica
        //                 Item itemMusica1 = new Item(null, "Thriller - Michael Jackson", tipoMusica, formatoCD,
        //                                 "Estante B",
        //                                 LocalDate.of(1982, 11, 30), EstadoItem.DISPONIBLE);
        //                 Item itemMusica2 = new Item(null, "Bohemian Rhapsody - Queen", tipoMusica, formatoVinilo,
        //                                 "Estante C",
        //                                 LocalDate.of(1975, 10, 31), EstadoItem.DISPONIBLE);
        //                 Item itemMusica3 = new Item(null, "The Dark Side of the Moon - Pink Floyd", tipoMusica,
        //                                 formatoCassette,
        //                                 "Estante C", LocalDate.of(1973, 3, 1), EstadoItem.DISPONIBLE);
        //                 Item itemMusica4 = new Item(null, "Back in Black - AC/DC", tipoMusica, formatoVinilo,
        //                                 "Estante A",
        ...
        //                 Item itemPelicula2 = new Item(null, "Matrix", tipoPelicula, formatoBluRay, "Estante A",
        //                                 LocalDate.of(1999, 3, 31),
        //                                 EstadoItem.DISPONIBLE);
        //                 Item itemPelicula3 = new Item(null, "El silencio de los corderos", tipoPelicula, formatoVHS,
        //                                 "Estante A",
        ...
        //                 // Libros
        //                 Item itemLibro1 = new Item(null, "El Señor de los Anillos", tipoLibro, formatoFisico,
        //                                 "Estante A",
        ...
        //                 Item itemLibro4 = new Item(null, "El Hobbit", tipoLibro, formatoFisico, "Estante B",
        ...
        //                 libro1.setFechaPublicacion(LocalDate.of(1954, 7, 29));
        ...
        //                 libro2.setFechaPublicacion(LocalDate.of(1949, 6, 8));
        ...
        //                 libro3.setFechaPublicacion(LocalDate.of(1967, 5, 30));
        ...
        //                 libro4.setFechaPublicacion(LocalDate.of(1937, 9, 21));

        //                 Libro libro5 = new Libro();
        //                 libro5.setItem(itemLibro5);
        //                 libro5.setAutor("Fiódor Dostoyevski");
        //                 libro5.setIsbn("978-84-206-5727-2");
        //                 libro5.setEditorial("Alianza");
        //                 libro5.setNumeroPaginas(672);
        //                 libro5.setFechaPublicacion(LocalDate.of(1866, 1, 1));

        //                 // Guardamos las entidades especificas
        //                 musicaRepository.saveAll(Arrays.asList(musica1, musica2, musica3, musica4, musica5));
        //                 peliculaRepository
        //                                 .saveAll(Arrays.asList(pelicula1, pelicula2, pelicula3, pelicula4, pelicula5));
        //                 libroRepository.saveAll(Arrays.asList(libro1, libro2, libro3, libro4, libro5));

        //                 // Crear Personas
        //                 Persona persona1 = new Persona(null, "Juan Pérez", "Calle Mayor 1", "juan@example.com",
        //                                 "123456789");
        //                 Persona persona2 = new Persona(null, "María López", "Calle Sol 2", "maria@example.com",
        //                                 "987654321");
        //                 Persona persona3 = new Persona(null, "Carlos García", "Avenida del Sol 15",
        //                                 "carlos@example.com",
        //                                 "654987321");
        //                 Persona persona4 = new Persona(null, "Laura Martínez", "Plaza de la Luna 8",
        //                                 "laura@example.com",
        //                                 "963852741");
        //                 Persona persona5 = new Persona(null, "Pedro Rodríguez", "Calle Estrella 22",
        //                                 "pedro@example.com",
        //                                 "666555444");
        ...
        //                                 Arrays.asList(prestamo1, prestamo2, prestamo3, prestamo4, prestamo5, prestamo6,
